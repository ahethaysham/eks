...
################################################################
### MUST ###
###---> aws eks update-kubeconfig --name mphasisalta-ca-eks --region us-east-1 <---
##################################################################

# Update Public to Private End Points
# aws eks update-cluster-config --name mphasisalta-ca-eks --region us-east-1 \
